...
def submit():
    ...
    #     response = "For treatment-related queries, please consult a medical professional."
    # else:
    #     response = main.allamak(user_query, st.session_state.crc, st.session_state.memory)
